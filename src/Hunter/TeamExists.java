...
// DO NOT EDIT OR ADD ANY CODE HERE!
        ...
        try {
            ...
            rs = statement.executeQuery("SELECT * FROM Hunter WHERE hunterID = " + id);

            //TODO This is loopable. More efficent way of doing things.
            while (rs.next()) {
                teamName = rs.getString(1);
                teamRank = rs.getString(2);
                hunterID = rs.getInt(3);
            }

            //TODO Make method here: getTeamMembers
            rs = statement.executeQuery("SELECT * FROM Hunter WHERE teamName =" + teamName);

            while (rs.next()) {
                String hunterName = rs.getString(2);


                lm.addElement(hunterName);
            }
